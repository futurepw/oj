...
<?php
?>
<form class="form-search navbar-form" action="status.php" method="get">
<?php echo $MSG_PROBLEM_ID?>:<input class="form-control" style="height:24px" type=text size=4 name=problem_id value='<?php echo $problem_id?>'>
<?php echo $MSG_USER?>:<input class="form-control" style="height:24px" type=text size=4 name=user_id value='<?php echo $user_id?>'>
...
echo "<input type=submit class=btn btn-default  value='$MSG_SEARCH'></form>";
?>
</div>
...
<thead>
<tr>
	<th width=8%><?php echo $MSG_RUNID?></th>
	<th width=10%><?php echo $MSG_USER?></th>
	<th width=10%><?php echo $MSG_PROBLEM?></th>
	<th width=10%><?php echo $MSG_RESULT?></th>
	<th width=8%><?php echo $MSG_MEMORY?></th>
	<th width=8%><?php echo $MSG_TIME?></th>
	<th width=8%><?php echo $MSG_LANG?></th>
	<th width=10%><?php echo $MSG_CODE_LENGTH?></th>
	<th width=20%><?php echo $MSG_SUBMIT_TIME?></th>
	<th width=8%><?php echo $MSG_JUDGER?></th>
</tr>
</thead>
<tbody>
    <?php
