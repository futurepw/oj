...
<center>
<table class="table table-hover" id=statics width=70%>
<caption>
...
<tr bgcolor=#D7EBFF>
	<td width=15%><?php echo $MSG_Number?></td>
	<td width=25% align=center><?php echo $Rank?></td>
	<td width=70% align=center>Solved Problems List</td>
</tr>
<tr bgcolor=#D7EBFF>
<td><?php echo $MSG_SOVLED?></td>
<td align=center><a href='status.php?user_id=<?php echo $user?>&jresult=4'><?php echo $AC?></a></td>
...
<tr bgcolor=#D7EBFF><td><?php echo $MSG_SUBMIT?></td>
